...
.brand-logo{width:48px;height:48px;border-radius:8px;object-fit:contain}.search{padding:10px 12px}.search input{width:100%;padding:10px;border-radius:10px;border:1px solid var(--border);background:#0d1322;color:var(--text)}
